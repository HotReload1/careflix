...
class Rule {
  ...
  @override
  String toString() {
    return 'Rule{openTime: $openTime, closeTime: $closeTime, blockedDates: $blockedDates, durationRules: $durationRules, blockedCategories: $blockedCategories, blockedShowsId: $blockedShowsId}';
  }
